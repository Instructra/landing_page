...
export default function Header() {
  return (
    <div className="fixed flex w-screen justify-center bg-(--bg-white) py-[32px]">
      <nav className="card-bg ll:w-[1200px] tb:w-[704px] flex w-[300px] items-center justify-between rounded-[100px] px-4">
        ...
        <button className="ll:inline hidden">Join the wait list</button>
