...
export default function IphoneMockUp({ url }: IphoneMockUpProps) {
  return (
    //  component
    <div className="h-inherit w-inherit flex items-center justify-center">
      {/* // iPhone 15 Container */}
      <div
        className="h-full w-full relative rounded-4xl border-6 border-zinc-900 shadow-[0_0_2px_2px_rgba(255,255,255,0.1)]"
      >
        {/* // Dynamic Island */}
