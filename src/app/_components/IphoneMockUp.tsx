...
function renderContent(url: string | null) {
  if (url) {
    return (
      <Image
        src={url}
...
export default function IphoneMockUp({ url, children }: IphoneMockUpProps) {
  return (
    //  component
    <div className="h-inherit w-inherit flex items-center justify-center">
      {/* // iPhone 15 Container */}
      <div className="relative h-full w-full rounded-4xl border-6 border-zinc-900 shadow-[0_0_2px_2px_rgba(255,255,255,0.1)]">
        {/* // Dynamic Island */}
